...
```{r}
# Read data ----
world_data  <- readr::read_csv(file = file.path(data_path, "raw_data", "World.csv"), show_col_types = FALSE)
kenya_data  <- readr::read_csv(file = file.path(data_path, "raw_data","Kenya.csv"), show_col_types = FALSE)
sweden_data <- readr::read_csv(file = file.path(data_path, "raw_data","Sweden.csv"), show_col_types = FALSE)
```
...
```{r}
# Function to create a table of the data of CBR 
...
|:-------|:-----------|:-----------|
| World  | 0.03732863 | 0.02021593 |
| Kenya  | 0.05209490 | 0.03851507 |
| Sweden | 0.01539614 | 0.01192554 |
...
regions <- c("Kenya (1950-1955)", "Kenya (2005-2010)", 
             "Sweden (1950-1955)", "Sweden (2005-2010)")
colors <- c('steelblue', 'orange', 'brown', 'purple')


# create bar plot
barplot(asfr_total, main = "ASFR for Kenya and Sweden", names.arg = age, 
                          xlab = "Age", ylab = "ASFR", 
                          col = colors, beside = TRUE, cex.names=0.5)
...
| Region | 1950-1955   | 2005-2010   |
|:-------|:------------|:------------|
| World  | 0.019318929 | 0.008166083 |
| Kenya  | 0.02396254  | 0.01038914  |
| Sweden | 0.009844842 | 0.009968455 |
...
# create bar plot
barplot(asdr_total, main = "ASDR for Kenya and Sweden in 2005-2010", names.arg = age, 
                          xlab = "Age", ylab = "ASDR", 
                          col = colors, beside = TRUE, cex.names=0.5)
...
Sweden's population distribution, such that we have a counterfactual CDR, 
it turns out to be 0.02321646. Thus if Kenya had the population proportion 
similar to Sweden, then the CDR turns out to be much higher. 
Therefore, we can infer that Sweden's popululation tends to have a higher 
proportion of people vulnerable to death.
